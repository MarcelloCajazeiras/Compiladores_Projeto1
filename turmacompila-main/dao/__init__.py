...
def conectar_cloudBD():
    con = psycopg2.connect(
        host= 'dpg-cnsg70ta73kc73b4o870-a.oregon-postgres.render.com',
        database= 'ferascompcloud_4qke',
        user= 'ferascompcloud_4qke_user',
        password= 'N93XadIpnCsguwhV3Ol0YF3dH4MVU6eA'
    )
    return con
